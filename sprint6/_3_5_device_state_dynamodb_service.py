        ...
        for device_state_record in device_state_record_list:
            ...
            if reachability and not properties_from_kinesis:
                response_device_reachability = update_device_reachability(table,
                                                                          str(device_state_record.get('partnerId')),
    ...
    device_state_record_v2 = [
        {
            ...
            "temperature_controller": {
                "measured_temperature": {'value': '24', 'updated_at': timestamp - 11},
                "mode": {'value': 'warm', 'updated_at': timestamp - 12},
            },
            "wind_controller": {
                'wind_speed': {'value': 'low', 'updated_at': timestamp - 11},
                'mode': {'value': 'high', 'updated_at': timestamp - 1}
            },
